...
public class EmailServiceImpl implements EmailService {  
	...
	public void sendAttachmentsMail(String sendTo, String titel, String content, Map<String, File> attachments) {
		...
		try {  
			...
			if (null != attachments) {
				...
				File file1 = new File("src/main/resources/template/李小龙.gif");
				File file2 = new File("src/main/resources/template/github.jpg");
	...
	public void sendInlineMail(String sendTo, String titel) {  
		...
		try {  
			...
			FileSystemResource file = new FileSystemResource(new File("src/main/resources/template/github.jpg"));
	...
	public void sendTemplateMail(String sendTo, String titel, Map<String, Object> content, Map<String, File> attachments) {
		...
		try {  
			...
			helper.setTo(sendTo);  
			helper.setSubject(titel);  
			String text = VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "template/email.vm", "UTF-8", content);  
